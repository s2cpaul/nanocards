			...
			<div className="max-w-2xl mx-auto px-4 py-6">
				<div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
					<p className="text-sm text-blue-900">
						<strong>Restore your 3 original cards.</strong> Edit the details
						below, then click "Restore" for each card.
					</p>
				</div>
							...
							<div className="space-y-4">
								...
								<div>
									...
									<Input
										...
										value={card.videoUrl}
										onChange={(e) =>
											handleUpdateCard(index, "videoUrl", e.target.value)
										}
										placeholder="https://..."
									/>
								</div>
								...
								<div>
									...
									<Input
										...
										onChange={(e) =>
											handleUpdateCard(index, "videoTime", e.target.value)
										}
										placeholder="0:00"
									/>
								</div>
								...
								<div>
									...
									<Input
										...
										onChange={(e) =>
											handleUpdateCard(index, "information", e.target.value)
										}
